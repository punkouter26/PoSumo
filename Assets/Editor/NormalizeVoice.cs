...
namespace PoSumo.EditorTools
{
    ...
    ///
    /// Deliberately scoped to the voice clips in Assets/Resources and NOT to
    /// Assets/Resources/Audio: those are generated by GenerateAudio at
    /// intentional relative levels, and levelling a music bed against a gong
    /// would flatten the mix rather than fix it.
    public static class NormalizeVoice
    {
        private const string ASSET_PATH = "Assets/Resources/VoiceGains.asset";
        private const string VOICE_FOLDER = "Assets/Resources";
        private const string GENERATED_FOLDER = "/Audio/";
        ...
        public static void Run()
        {
            ...
            foreach (string guid in guids)
            {
                ...
                if (path.Contains(GENERATED_FOLDER))
                {
                    continue;
                }
